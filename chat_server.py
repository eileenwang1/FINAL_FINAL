...
class Server:
    def __init__(self):
        ...
        self.indices = {}
        # sonnet
        self.sonnet = idx.PIndex("AllSonnets.txt")
...
# ==============================================================================
                ...
                # ---- start your code ---- #
                cls_idx = idx.Index(1)
                cls_idx.add_msg_and_index(msg["msg"])
                # ---- end of your code --- #

                the_guys = self.group.list_me(from_name)[1:]
                print("here are the guys", the_guys)
                for g in the_guys:
                    to_sock = self.logged_name2sock[g]
...
# ==============================================================================
                ...
                # IMPLEMENTATION
                # ---- start your code ---- #
                msg["msg"] = json.dumps(self.group.members)
...
# ==============================================================================
                ...
                num = msg["target"]
                '''
                if num.is_digit() is False:
                    #covert roman letters to digits
                    r_f = open("roman.txt","r")
                    line_list = []
                    while True:
                        line = r_f.readline()
                        if len(line) == 0:
                    ...
                    for i in line_list:
                        if num in line_list:
                            to_process = i
                            break
                    new_list = to_process.split(":")
                    num = new_list[0]
                '''
                num = int(num)
                p_class = idx.PIndex(num)
                p_l = p_class.get_poem(num)
                poem = "".join(p_l)
                print('here:\n', poem)
